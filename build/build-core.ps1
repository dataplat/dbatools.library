...
$null = New-Item -ItemType Directory ./lib/sqlpackage -ErrorAction Ignore
...
Get-ChildItem "./temp/dacfull/" -Include *.dll, *.exe -Recurse | Copy-Item -Destination lib/sqlpackage
...
Get-ChildItem lib/dbatools.dll | Remove-Item -Force
Get-ChildItem lib/dbatools.dll.config | Remove-Item -Force
