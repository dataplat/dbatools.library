...
/// process emits directly via WriteObject and its ConnectionError Stop-Function is a per-instance loop-continue, so
/// no scriptblock-hop stream buffering is involved (that is a native port, not a hop). Surface pinned by
/// migration/baselines/Get-DbaReplServer.json.
/// </summary>
