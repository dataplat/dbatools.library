...
/// <summary>
/// Creates a Microsoft.SqlServer.Replication.CreationScriptOptions flags value (W4-105).
...
///
/// EnableException is inherited from DbaBaseCmdlet - never redeclared (CD-0721-09).
/// </summary>
...
public sealed class NewDbaReplCreationScriptOptionsCommand : DbaBaseCmdlet
{
    ...
    // PS src:98 — the SSMS-default flags applied unless -NoDefaults, verbatim order and names.
