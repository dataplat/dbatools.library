...
public sealed class GetDbaDbRoleCommand : DbaBaseCmdlet
{
    ...
    protected override void ProcessRecord()
    {
        ...
        foreach (PSObject? item in NestedCommand.InvokeScoped(this, ProcessScript,
            ...
            InputObject, EnableException.ToBool(), NestedCommand.BoundCommonParameter(this, "Verbose"), NestedCommand.BoundCommonParameter(this, "Debug")))
        {
...
& $__dbatoolsModule {
    [CmdletBinding()]
    param([Dataplat.Dbatools.Parameter.DbaInstanceParameter[]]$SqlInstance, [PSCredential]$SqlCredential, [string[]]$Database, [string[]]$ExcludeDatabase, [string[]]$Role, [string[]]$ExcludeRole, $ExcludeFixedRole, [Microsoft.SqlServer.Management.Smo.Database[]]$InputObject, $EnableException, $__boundVerbose, $__boundDebug)
