...
public sealed class ImportDbaBinaryFileCommand : DbaBaseCmdlet
{
    ...
    // Carried across records (W2-128 P0): the source guards its whole column-detect + $Statement-build block with
...
& $__dbatoolsModule {
    ...
    # W2-128 cross-record carry: restore the persisted $Statement + detected columns from the previous record
