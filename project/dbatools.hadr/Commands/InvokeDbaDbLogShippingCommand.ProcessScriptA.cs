...
& $__dbatoolsModule {
    ...
    param($SourceSqlInstance, $DestinationSqlInstance, $SourceSqlCredential, $SourceCredential, $DestinationSqlCredential, $DestinationCredential, $Database, $SharedPath, $LocalPath, $AzureBaseUrl, $AzureCredential, $BackupJob, $BackupRetention, $BackupSchedule, $BackupScheduleFrequencyType, $BackupScheduleFrequencyInterval, $BackupScheduleFrequencySubdayType, $BackupScheduleFrequencySubdayInterval, $BackupScheduleFrequencyRelativeInterval, $BackupScheduleFrequencyRecurrenceFactor, $BackupScheduleStartDate, $BackupScheduleEndDate, $BackupScheduleStartTime, $BackupScheduleEndTime, $BackupThreshold, $CopyDestinationFolder, $CopyJob, $CopyRetention, $CopySchedule, $CopyScheduleFrequencyType, $CopyScheduleFrequencyInterval, $CopyScheduleFrequencySubdayType, $CopyScheduleFrequencySubdayInterval, $CopyScheduleFrequencyRelativeInterval, $CopyScheduleFrequencyRecurrenceFactor, $CopyScheduleStartDate, $CopyScheduleEndDate, $CopyScheduleStartTime, $CopyScheduleEndTime, $FullBackupPath, $HistoryRetention, $PrimaryMonitorServer, $PrimaryMonitorCredential, $PrimaryMonitorServerSecurityMode, $RestoreDataFolder, $RestoreLogFolder, $RestoreDelay, $RestoreAlertThreshold, $RestoreJob, $RestoreRetention, $RestoreSchedule, $RestoreScheduleFrequencyType, $RestoreScheduleFrequencyInterval, $RestoreScheduleFrequencySubdayType, $RestoreScheduleFrequencySubdayInterval, $RestoreScheduleFrequencyRelativeInterval, $RestoreScheduleFrequencyRecurrenceFactor, $RestoreScheduleStartDate, $RestoreScheduleEndDate, $RestoreScheduleStartTime, $RestoreScheduleEndTime, $RestoreThreshold, $SecondaryDatabasePrefix, $SecondaryDatabaseSuffix, $SecondaryMonitorServer, $SecondaryMonitorCredential, $SecondaryMonitorServerSecurityMode, $StandbyDirectory, $UseBackupFolder, $BackupScheduleDisabled, $CompressBackup, $CopyScheduleDisabled, $DisconnectUsers, $Force, $GenerateFullBackup, $IgnoreFileChecks, $NoInitialization, $NoRecovery, $PrimaryThresholdAlertEnabled, $RestoreScheduleDisabled, $SecondaryThresholdAlertEnabled, $Standby, $UseExistingFullBackup, $EnableException, $__state, $__boundWhatIf, $__boundConfirm, $__boundVerbose, $__boundDebug)
