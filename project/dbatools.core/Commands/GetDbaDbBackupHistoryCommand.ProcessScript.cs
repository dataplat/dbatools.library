...
public sealed partial class GetDbaDbBackupHistoryCommand
{
    ...
    // The verbatim process body is one semantic unit; it is carried as two compile-time
    // concatenated const halves (Head here, Tail in its own partial) purely to satisfy the
    // 400-line file law - the composed runtime string is byte-identical to the original.
