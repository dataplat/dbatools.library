<#
.SYNOPSIS
    Ralph Wiggum migration orchestrator for the xevent domain (20 commands).

.DESCRIPTION
    Iteratively invokes Claude Code to convert xevent commands from PS1 to C# binary cmdlets.
