<#
.SYNOPSIS
    Ralph Wiggum migration orchestrator for the dbmail domain (12 commands).

.DESCRIPTION
    Iteratively invokes Claude Code to convert dbmail commands from PS1 to C# binary cmdlets.
...
$TrackerPath = [IO.Path]::Combine($RepoRoot, 'docs', 'plan', 'TRACKER-MIGRATE-DBMAIL.md')
$SignalFile = [IO.Path]::Combine($RepoRoot, 'docs', 'plan', '.migrate-dbmail-complete')
